...
public TestObject changeTestString(TestObject obj){
	...
	//((TestObject)obj).setTestString(((TestObject)obj).getTestString() + " - date " + new GregorianCalendar(TimeZone.getDefault()).toString());
	obj.setTestString(obj.getTestString() + " - date " + String.valueOf(System.currentTimeMillis()));
	return  obj;
}
