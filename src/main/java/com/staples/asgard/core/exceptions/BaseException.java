...
/**
 * BaseException is the base class for all exceptions thrown within Asgard
 * applications.
 * 
 * @author
 */
public class BaseException extends Exception {
	...
	/**
	 * Creates the sets errorcode, erromessage.
	 * 
	 * @param asgardError
	 * @param ex
	 */
	...
	/**
	 * Creates the BrowseException, sets errorcode, erromessage and gets the
	 * Exception .
	 * 
	 * @param asgardError
	 * @param ex
